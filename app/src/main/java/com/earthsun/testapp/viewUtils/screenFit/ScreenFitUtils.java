package com.earthsun.testapp.viewUtils.screenFit;
...
import com.earthsun.testapp.viewUtils.DensityUtils;
import com.earthsun.testapp.viewUtils.ResourceUtils;
...
public class ScreenFitUtils {
     ...
     * @param views 适配多个布局
     */
    public static void autos(View... views) {
        for (View view : views) {
            auto(view);
        }
    }
